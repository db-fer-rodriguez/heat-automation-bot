...
// Función para iniciar bot de forma segura
async function iniciarBotSeguro() {
    try {
        ...
        // Obtener info del bot para verificar token
        const botInfo = await bot.getMe();
        console.log('🤖 Bot conectado:', botInfo.username);
        
        // Esperar un momento antes de iniciar polling
...
app.listen(PORT, async () => {
    ...
    console.log('🤖 Iniciando bot HEAT...');
    
    // Iniciar bot de forma segura
